...
function showIncrease() {
    var URL = "http://localhost:8010/api/item/GetPersonIncrease";
...
function drawBarChart() {
    ...
    var URL = "http://localhost:8010/api/item/getpersonstop/5";
    makeAjaxCall(URL, "GET").then(process);
    var can = $('#bar-chart');
...
function drawLineChart() {
    var URL = "http://localhost:8010/api/item/GetMostPopularPersons/3";
    makeAjaxCall(URL, "GET").then(process);
    ...
    function process(output) {
        ...
        $.each(output,
            function (key, value) {
                var URL = "http://localhost:8010/api/item/GetPersonEvolution/" + key;
                makeAjaxCall(URL, "GET").then(process);
...
function TrendingPersonGraphs() {
    var URL = "http://localhost:8010/api/item/getMostPopularPerson";
    makeAjaxCall(URL, "GET").then(process);
...
function drawOrganisations() {
    var URL = "http://localhost:8010/api/item/GetMostPopularOrganisations/3";
    ...
    function process(output) {
        ...
        $.each(output,
            function (key, value) {
                var URL = "http://localhost:8010/api/item/GetItemTweet/" + key;
                makeAjaxCall(URL, "GET").then(process, errorHandler);
