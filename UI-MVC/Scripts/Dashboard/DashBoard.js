...
DashData = $.ajax({
    ...
    dataType: 'json',
    headers: Headers,
    url: "http://localhost:51379/api/dashboard/getdashboardzones/" + DashBoardId
}).responseJSON;
    ...
    new function () {
        ...
        findElements = function (id) {
            var ZoneData = $.ajax({
                ...
                dataType: 'json',
                headers: Headers,
                url: "http://localhost:51379/api/dashboard/getzoneelements/" + id
            }).responseJSON;
        ...
        deleteElement = function (element, grid) {
            ...
            $.ajax({
                ...
                type: 'POST',
                headers: Headers,
                url: "http://localhost:51379/api/dashboard/deleteelement/" + ElementId
            })
        ...
        addElement = function (grid) {
            ...
            if (ZoneId === 'x') {
                ...
                ZoneId = $.ajax({
                    ...
                    dataType: 'json',
                    headers: Headers,
                    url: "http://localhost:51379/api/dashboard/postzone/" + DashBoardId
                }).responseJSON.ZoneId
            ...
            var ElementId = $.ajax({
                ...
                dataType: 'json',
                headers: Headers,
                url: "http://localhost:51379/api/dashboard/postelement/" + ZoneId
                        ...
                        switch ($('input:checked').attr('id')) {
                            case 'person':
                                ...
                                data = $.ajax({
                                    ...
                                    type: 'GET',
                                    headers: Headers,
                                    url: "http://localhost:51379/api/item/getperson"
                                }).responseJSON;
                            ...
                            case 'organisation':
                                ...
                                data = $.ajax({
                                    ...
                                    type: 'GET',
                                    headers: Headers,
                                    url: "http://localhost:51379/api/item/getorganisation"
                                }).responseJSON;
                            ...
                            case 'theme':
                                ...
                                data = $.ajax({
                                    ...
                                    type: 'GET',
                                    headers: Headers,
                                    url: "http://localhost:51379/api/item/gettheme"
                                }).responseJSON;
                                onderwerp = 'thema';
                                break;
                        }
                                ...
                                if (cardnumber <= 5) {
                                    ...
                                    $('#card' + cardnumber).children('.card').children('img').on('click', function () {
                                        var item = ($.ajax({
                                            ...
                                            type: 'GET',
                                            headers: Headers,
                                            url: "http://localhost:51379/api/item/getitem/" + $("#locality-dropdown option:selected").attr('value')
                                        }).responseJSON);
            ...
            $('.btn-finish').on('click', function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    headers: Headers,
                    url: "http://localhost:51379/api/dashboard/putelement/" + ElementId
                })
        ...
        editZone = function (grid) {
            ...
            grid.on('click', function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    headers: Headers,
                    url: "http://localhost:51379/api/dashboard/putzone/" + ZoneId
                })
                    ...
                    if (ElementId !== '+') {
                        if (ZoneId === 'x') {
                            ...
                            var Element = $.ajax({
                                ...
                                type: 'GET',
                                headers: Headers,
                                url: "http://localhost:51379/api/dashboard/getelement/" + ElementId
                            }).responseJSON
            ...
            $.each(cards.children(), function () {
                ...
                if (itemId !== '#') {
                    items.push($.ajax({
                        ...
                        type: 'GET',
                        headers: Headers,
                        url: "http://localhost:51379/api/item/getitem/" + itemId
                    }).responseJSON);
                }
            })
            return items;
        ...
        resetWizard = function (wizard) {
            ...
            $.getScript("http://localhost:51379/Scripts/Wizard/jquery.validate.min.js")
                .done(function (script, textStatus) {
                })
                .fail(function (jqxhr, settings, exception) {
                    console.log("Triggered ajaxError handler.");
                });
            $.getScript("http://localhost:51379/Scripts/Wizard/jquery.bootstrap.js")
                .done(function (script, textStatus) {
                })
                .fail(function (jqxhr, settings, exception) {
                    console.log("Triggered ajaxError handler.");
                });
            $.getScript("http://localhost:51379/Scripts/Wizard/material-bootstrap-wizard.js")
                .done(function (script, textStatus) {
                })
                .fail(function (jqxhr, settings, exception) {
                    console.log("Triggered ajaxError handler.");
                    ...
                    _.each(elements, function (node) {
                        if (!node.IsUnfinished) {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                headers: Headers,
                                url: "http://localhost:51379/api/dashboard/deleteelement/" + node.ElementId
                            })
                        }
                    }, this);
        ...
        DrawHashtags = function (can, itemIds, graph, elementId) {
            ...
            if (itemIds.length == 1) {
                var URL = "http://localhost:51379/api/item/GetTrendingHashtagsCount/" + itemIds[0].ItemId;
                ...
                $.each(itemIds,
                    function (index, value) {
                        var URL = "http://localhost:51379/api/item/GetTrendingHashtagsCountOverall/" + value.ItemId;
                        makeAjaxCall(URL, "GET").then(process);
        ...
        DrawMentions = function (can, itemIds, graph, elementId) {
            ...
            if (itemIds.length == 1) {
                var URL = "http://localhost:51379/api/item/GetTrendingMentionsCount/" + itemIds[0].ItemId;
                makeAjaxCall(URL, "GET").then(process);
                ...
                $.each(itemIds,
                    function (index, value) {
                        var URL = "http://localhost:51379/api/item/GetTrendingMentionsCountOverall/" + value.ItemId;
                        makeAjaxCall(URL, "GET").then(process);
        ...
        DrawWords = function (can, itemIds, graph, elementId) {
            ...
            if (itemIds.length == 1) {
                var URL = "http://localhost:51379/api/item/GetTrendingWordsCount/" + itemIds[0].ItemId;
                makeAjaxCall(URL, "GET").then(process);
                ...
                $.each(itemIds,
                    function (index, value) {
                        var URL = "http://localhost:51379/api/item/GetTrendingWordsCountOverall/" + value.ItemId;
                        makeAjaxCall(URL, "GET").then(process);
                        function process(output2) {
                            var keys = [];
                            keys = Object.keys(output2);
        ...
        DrawAge = function (can, itemIds, graph, elementId) {
            ...
            $.each(itemIds,
                function (index, value) {
                    var URL = "http://localhost:51379/api/item/GetAges/" + value.ItemId;
                    makeAjaxCall(URL, "GET").then(process);
        ...
        DrawGender = function (can, itemIds, graph, elementId) {
            ...
            $.each(itemIds,
                function (index, value) {
                    var URL = "http://localhost:51379/api/item/GetGender/" + value.ItemIds;
                    makeAjaxCall(URL, "GET").then(process);
        ...
        DrawSentiment = function (can, itemIds, graph, elementId) {
            ...
            $.each(itemIds,
                function (index, value) {
                    var URL = "http://localhost:51379/api/item/GetPersonEvolution/" + value.ItemId;
                    makeAjaxCall(URL, "GET").then(process);
        ...
        DrawEvolution = function (can, itemIds, graph, elementId) {
            ...
            $.each(itemIds,
                function (index, value) {
                    var URL = "http://localhost:51379/api/item/GetItemTweet/" + value.ItemId;
                    makeAjaxCall(URL, "GET").then(process);
