...
namespace PB.BL.Domain.JSONConversion
{
    public class JClass
    {
        public JClass(RecordProfile profile, List<string> words, List<double> sentiment, string source,
            List<string> hashtags, List<string> mentions, List<string> uRLs, List<string> themes, List<string> persons,
            DateTime date, dynamic geo, long id, bool retweet)
        {
            Profile = profile;
            Words = words;
            Sentiment = sentiment;
