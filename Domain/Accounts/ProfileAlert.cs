...
namespace PB.BL.Domain.Accounts
{
    ...
    {
        [DataMember] [Key] public int ProfileAlertId { get; set; }

        [DataMember] public string UserId { get; set; }

        [DataMember] public int AlertId { get; set; }

        [DataMember] [Required] public bool IsRead { get; set; }

        [DataMember] [Required] public DateTime TimeStamp { get; set; }

        [Required] public Profile Profile { get; set; }

        [DataMember] [Required] public virtual Alert Alert { get; set; }
