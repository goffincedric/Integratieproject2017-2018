...
namespace PB.BL.Senders
{
    public class GmailSender
    {
        ...
        public static string WeeklyReviewListItem =
            @"<li style='margin-bottom: 25px;padding: 15px;list-style: none;display: inline-flex;background: #efefef;'>
                <img src='" + WeeklyReviewListItemIconSubstring + @"' style='margin-right: 15px; max-width: 10%; max-height: 100px; width: auto; height: auto; object-fit: contain;'>
                <div style='width: 85%;'>
                    <h4><a href='" + DefaultItemLinkSubstring + @" style='margin: 0; font-size: 1.5em; text-decoration: none; color: dimgray;'> " + WeeklyReviewListItemNameSubstring + @" </a></h4>
                    <p style='margin: 0;padding: 0;margin-bottom: 10px;font-weight: 500;color: #96a6b0;font-size: 1.2em;line-height: 1.6;'>" + WeeklyReviewListItemDescriptionSubstring + @"</p>
                </div>
            </li>";
        public static string WeeklyReviewBody =
            @"
            <link href='https://fonts.googleapis.com/css?family=Convergence' rel='stylesheet'>
            <div style='font-family: Convergence, " + '"' + "Open Sans" + '"' + @", Arial, sans-serif;margin-bottom: 0;width: 100%;min-height: 100px;display: table;border-collapse: collapse;border-spacing: 0;border-top-left-radius: 25px;border-top-right-radius: 25px;background-color: #00bfff;text-align: center;'>
            <h1 style='margin: 0;display: table-cell;vertical-align: middle;font-weight: 300;font-size: 75px;font-variant: all-small-caps;color: aliceblue;'> Weekly review</h1>
            </div>
            <div id='content'>
            ...
            <div style='font-family: Convergence, " + '"' + "Open Sans" + '"' + @", Arial, sans-serif;margin-bottom: 0;width: 100%;min-height: 100px;display: table;border-collapse: collapse;border-spacing: 0;border-bottom-left-radius: 25px;border-bottom-right-radius: 25px;background-color: #96a6b0;text-align: center;'>
