...
namespace PB.BL
{
  public interface IItemManager
  {
    ...
    Record AddRecord(string source, long id, string user_Id, List<Mention> mentions, DateTime date, string geo, List<Politician> politician, bool retweet, List<Words> words, Sentiment sentiment, List<Hashtag> hashtags, List<Url> uRLs);
